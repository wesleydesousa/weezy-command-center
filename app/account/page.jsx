...
export default async function AccountPage() {
  ...
  if (!user) return <main className="account-shell">
    ...
    <section className="account-hero">
      <span className="eyebrow">CONTA WEEZY</span><h1>Acesse sua conta.</h1>
      <p>Entre para visualizar seu plano, limites e histórico de pagamentos.</p>
    </section>
  ...
  return <main className="account-shell">
    <header className="account-topbar">
      <a className="brand" href="/"><span className="brand-mark">W</span><span><strong>WEEZY</strong><small>COMMAND CENTER</small></span></a>
      <a className="account-link" href="/">Voltar ao painel</a><a className="account-link" href={chatGPTSignOutPath("/")}>Sair</a>
    </header>
    <section className="account-hero">
      <span className="eyebrow">CONTA WEEZY</span><h1>Seu espaço de criação.</h1>
      <p>{account.profile?.name || user.displayName}<br /><span>{account.profile?.email || user.email}</span></p>
    </section>
